      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="mt-4 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <MetricCard label="Total Deals" value="24" delta={{ value: 12, isPositive: true }} icon={"↗"} />
            <MetricCard label="Active Outreach" value="8" delta={{ value: 3, isPositive: true }} icon={"✉️"} />
            <MetricCard label="Response Rate" value="68%" delta={{ value: 5, isPositive: false }} icon={"📊"} />
            <MetricCard label="Avg Deal Value" value="$2.4k" delta={{ value: 18, isPositive: true }} icon={"💵"} />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4">
            <ActivityList items={[
              ...
              { id: 3, title: "New Brand Match", timeAgo: "10 minutes ago" },
              { id: 4, title: "Outreach Sent", timeAgo: "15 minutes ago" }
            ]} />
          </div>
        </div>
      </div>
