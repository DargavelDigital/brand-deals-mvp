...
export default function RadialStepper({ step }: Props){
  ...
  return (
    <div className="card p-6 min-h-[320px] md:min-h-[400px] flex flex-col">
      <div className="text-sm font-medium mb-6">Brand Run Progress</div>

      {/* Radial stepper container - centered with responsive sizing */}
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-[400px] h-auto flex items-center justify-center">
          <svg 
            width={size} 
            height={size} 
            className="radial-wrap w-full h-auto max-w-full" 
            role="group" 
